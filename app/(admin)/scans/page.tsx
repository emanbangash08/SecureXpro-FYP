...
function ScanTypeIcon({ type }: { type: ApiScanType }) {
  ...
  switch (type) {
    case "reconnaissance":
      return <Server {...props} color="#4d9eff" />;
    case "vulnerability":
      return <AlertCircle {...props} color="#ff6b35" />;
    case "web_assessment":
      return <Globe {...props} color="#a78bfa" />;
    case "full":
      return <Layers {...props} color="#00e5cc" />;
  }
}
...
export default function ScansPage() {
  ...
  const [statusFilter, setStatusFilter] = useState<"all" | ApiScanStatus>(
    "all",
  );
    ...
    >
      ...
      >
        <div>
          ...
          >
            Monitor and manage all security assessments. Auto-refreshes while
            scans are active.
          </p>
        </div>
        <button
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <select
              ...
              style={sel}
            >
              <option value="all" {...opt}>
                All Types
              </option>
              <option value="reconnaissance" {...opt}>
                Reconnaissance
              </option>
              <option value="vulnerability" {...opt}>
                Vulnerability
              </option>
              <option value="web_assessment" {...opt}>
                Web Assessment
              </option>
              <option value="full" {...opt}>
                Full Scan
              </option>
            </select>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            >
              ...
              <option value="pending" {...opt}>
                Pending
              </option>
              <option value="running" {...opt}>
                Running
              </option>
              <option value="completed" {...opt}>
                Completed
              </option>
              <option value="failed" {...opt}>
                Failed
              </option>
              <option value="cancelled" {...opt}>
                Cancelled
              </option>
            </select>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Delete — type=button + stopPropagation so the click
                          can't bubble to any parent link/handler and trigger
