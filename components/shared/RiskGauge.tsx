...
export function RiskGauge({ score, size = "md" }: RiskGaugeProps) {
  ...
  const getRiskColor = (score: number) => {
    if (score >= 80) return "#EF4444"; // Critical — Alarm Red
    if (score >= 60) return "#F97316"; // High — Threat Amber
    if (score >= 40) return "#EAB308"; // Medium — Caution Yellow
    if (score >= 20) return "#22C55E"; // Low — Safe Green
    return "#94A3B8"; // Info / None — Neutral Slate
  };
